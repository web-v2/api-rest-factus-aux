...
const filePaths = {
    clientes: path_1.default.resolve(__dirname, "../db/clientes.json"),
    productos: path_1.default.resolve(__dirname, "../db/productos.json"),
};
/**
    ...
    try {
        for (const [key, filePath] of Object.entries(filePaths)) {
            if (!(yield fs_extra_1.default.pathExists(filePath))) {
                ...
                yield fs_extra_1.default.writeJSON(filePath, []); // Inicializa con un array vacío
            }
        }
    }
    catch (error) {
